...
$sql_sold = "SELECT products.product_id, products.SKU_UPC_MPN, products.brand, products.price, SUM(cart_product.lengthBuy) AS total_sold FROM cart_product JOIN products ON cart_product.product_id = products.product_id GROUP BY products.product_id";
    ...
    <div class="content">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h4 class="text-center mb-0">Thống kê sản phẩm bán được</h4>
            </div>
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="thongke_sanpham_ban.php" class="btn btn-primary">Thống kê doanh thu</a>
